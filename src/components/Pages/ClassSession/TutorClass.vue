      ...
      <div class="card-ish card-100">
        <div class="top">
          ...
          <h5>
            ...
            Tutoring Fee&nbsp;<b>[&#8358;{{ number_format(c && c.monthly_tutor_pay) }}]</b>
          </h5>
          <div class="sasasa"></div>
        </div>
        <div class="body">
              ...
              <div class="items">
                <ul>
                  <li>
                    ...
                    Status:&nbsp; <span class="status" :class="c.status ? c.status.name.toLowerCase() : 'default'"></span> {{ c.level !== null && c.level == 1 ? 'Pending' : 'Active' }}
                  </li>
                  <li>
                  ...
                  <li>
                    ...
                    Expected duration of classes:&nbsp; 2 weeks
                  </li>
                </ul>
              </div>
            </div>
