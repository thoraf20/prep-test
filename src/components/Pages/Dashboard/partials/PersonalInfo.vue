  ...
  <div class="cont">
    ...
    <div class="row m-0">
      <div class="col-md-12 left-nav p-0">
        <ul>
          <li @click="() => active = 'basic'" :class="{active: (active === 'basic')}"><span>A</span>Basic Info</li>
          <li @click="() => active = 'location'" :class="{active: (active === 'location')}"><span>B</span>Location Info</li>
          <li  @click="() => active = 'bio'" :class="{active: (active === 'bio')}"><span>C</span>Short Bio</li>
        </ul>
      </div>
      <div class="col-md-12 p-0" v-if="active === 'basic'">
        <profile-basic :isdash="true"></profile-basic>
      </div>
      <div class="col-md-12 p-0" v-if="active === 'location'">
        <profile-location :isdash="true"></profile-location>
      </div>
      <div class="col-md-12 p-0" v-if="active === 'bio'">
        <profile-about :isdash="true"></profile-about>
      </div>
    </div>
  </div>
</template>
