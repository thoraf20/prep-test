...
export default {
  ...
  methods: {
    ...
    toggleDropout() {
      this.$refs.dropout.classList.toggle('hide');
    },
  },
};
</script>
...
.sidebar--links {
  ...
  .sidebar--link {
    ...
    &.router-link-exact-active {color: #639440;}
    &.active {color: #639440;}
    &:hover {text-decoration: none; color: #639440; background-color: rgba(2, 17, 27, 0.25);}
    &.has-dropout {
      position: relative;
      .dropout {
        position: absolute;
