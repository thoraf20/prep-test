          ...
          <div class="col-lg-6 col-12">
            <div class="action--card r">
              <div class="action--card--details">
                ...
                <p v-else>You have {{ ac.filter((s) => { return s.level  == 1}).length}}
                          {{ ac.filter((s) => { return s.level  == 1}).length > 1 ? 'classes' : 'class'}} under Fulfilment,
                           and {{ ac.filter((s) => { return s.level  == 3}).length}} {{ ac.filter((s) => { return s.level  == 3}).length > 1 ? 'classes' : 'class'}} under Connection.. </p>
              </div>
          ...
          <div class="col-lg-6 col-12">
            <div class="action--card r">
              <div class="action--card--details">
                ...
                <h5>Edit Profile</h5>
                <p>Edit your personal information, educational and work experience.</p>
              </div>
              <div class="action--card--action">
  ...
  .actions {
    ...
    .action--card {
      ...
      .action--card--details {
        ...
        align-items: center;
        svg {margin: 15px 0;}
        h5 {font-weight: 800; color: #4D4F5C; margin: 10px;}
        p {font-weight: 300; color: #4D4F5C; margin: 0; width: 220px; text-align: center;}
      }
      .action--card--action {
        button {
          width: 110px;
