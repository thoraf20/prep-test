  ...
  <div class="cont">
    ...
    <div class="row m-0">
      <div class="col-md-12 left-nav p-0">
        <ul>
          <router-link tag="li" :to="{ name: 'educational-info-setup' }"><span>A</span>Educational Info</router-link>
          <router-link tag="li" :to="{ name: 'teaching-info-setup' }" :class="{disabled: !u.progress.education }"><span>B</span>Teaching Info</router-link>
          <router-link  tag="li":to="{ name: 'work-experience-setup' }"  :class="{disabled: !u.progress.teaching }"><span>C</span>Work Experience</router-link>
        </ul>
      </div>
